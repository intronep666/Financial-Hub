...
REM Start backend API server via PowerShell scriptcd /d "%~dp0backend"

powershell.exe -ExecutionPolicy Bypass -File "%~dp0scripts\dev\start-backend.ps1"REM Development environment variables

pauseIF NOT DEFINED USE_SQLITE set USE_SQLITE=true
